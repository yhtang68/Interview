...
| [`src/services/wiremockService.ts`](./src/services/wiremockService.ts) | - Owns fixed WireMock Admin API routes.<br>- Verifies mock health.<br>- Creates, updates, and removes scenario-owned dynamic mappings. |
